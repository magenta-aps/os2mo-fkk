...
from os2mo_fkk.autogenerated_graphql_client import EventSendInput
...
# Namespace and routing key of the FKK `change` events sent to and received from
# MO's event system.
FKK_NAMESPACE = "fkk"
FKK_ROUTING_KEY = "change"
...
class FKKEventGenerator(AsyncContextManager):
    ...
    async def _generate(self) -> None:
        ...
        async with self._sessionmaker() as session, session.begin():
            ...
            await gather_with_concurrency(100, *send_tasks)
